...
static const uint8_t font8x8_basic[128][8] = {
    ...
    {0x7f, 0x63, 0x7f, 0x63, 0x63, 0x67, 0xe0, 0xc0},
    ...
    {0x3c, 0x66, 0x70, 0x78, 0x70, 0x60, 0xf0, 0x00},
...
extern struct framebuffer* gfx_framebuffer(void);
...
void font_draw_string(int x, int y, const char* text, uint32_t color) {
    ...
    while (*text) {
        font_draw_char(cursor_x, y, *text, color);
